...
>
> Development of the DLQ service continues in the GHGA mono repository at
> [ghga-de/ghga](https://github.com/ghga-de/ghga), where the service now lives under
> [`services/dlq-service`](https://github.com/ghga-de/ghga/tree/main/services/dlq-service).
> Please open issues and pull requests there.
>
> This repository is kept read-only for its history. Version 4.1.1 (September 2026) was the
...
A pre-built version is available on [Docker Hub](https://hub.docker.com/repository/docker/ghga/dlq-service):
```bash
docker pull ghga/dlq-service:4.1.1
```

Or you can build the container yourself from the [`./Dockerfile`](./Dockerfile):
```bash
# Execute in the repo's root dir:
docker build -t ghga/dlq-service:4.1.1 .
```
...
docker run -p 8080:8080 ghga/dlq-service:4.1.1 --help
```
